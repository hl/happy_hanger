defmodule HappyHangerWeb.ProductLiveTest do
  use HappyHangerWeb.ConnCase

  import Phoenix.LiveViewTest
  import HappyHanger.ProductsFixtures

  @create_attrs %{name: "some name", description: "some description", sku: "some sku", cost_price: "120.5", price: "120.5", stock_level: 42, notes: "some notes"}
